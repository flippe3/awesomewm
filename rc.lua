...
language_en = "setxkbmap us"
language_swe = "setxkbmap se"
evince = "evince"
...
globalkeys = gears.table.join(
   ...
   awful.key({ modkey,           }, "e", function () awful.spawn(evince) end,
      {description = "open a terminal", group = "launcher"}),
   awful.key({ }, "F12", function () awful.spawn(brightness_up) end,
      {description = "open a terminal", group = "launcher"}),
   awful.key({ }, "F11", function () awful.spawn(brightness_down) end,
      {description = "open a terminal", group = "launcher"}),
   awful.key({ }, "F10", function () kbdcfg.switch() end,
      {description = "Switches language between swedish and us", group = "launcher"}),
   ...
   awful.key({                   }, "F3", function() awful.util.spawn("pavolume volup") end),
   awful.key({                   }, "F2", function() awful.util.spawn("pavolume voldown") end),
   awful.key({                   }, "F1", function() awful.util.spawn("pavolume mutetoggle") end),
   ...
   awful.key({ modkey,           }, "s", function () awful.spawn("spotify") end,
      {description = "open a spotify", group = "launcher"}),
